    ...
    <div className="pt-32 pb-32 px-6 bg-stone-50/30">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="mt-8 max-w-2xl mx-auto rounded-2xl border-2 border-sage-600/35 bg-gradient-to-br from-sage-50 via-white to-sage-100/60 px-5 py-5 sm:px-7 sm:py-6 shadow-[0_8px_32px_rgba(90,120,80,0.14)] ring-1 ring-sage-600/15">
            <div className="flex gap-4 text-left">
              <span
                className="mt-0.5 inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-sage-600 text-white shadow-md"
                aria-hidden
              >
                <Info className="h-5 w-5" strokeWidth={2.25} />
              </span>
              <div className="space-y-3 text-sm sm:text-[15px] text-stone-700 leading-relaxed">
                <p className="font-medium text-stone-800">
                  ネットからのご予約は<strong className="text-sage-800">仮予約</strong>
                  となります。
                </p>
                <p>
                  確定のご案内は、必ずご入力いただいた
                  <strong className="text-sage-800 font-semibold">メールアドレス</strong>
                  宛にお送りします。
                </p>
              </div>
            </div>
